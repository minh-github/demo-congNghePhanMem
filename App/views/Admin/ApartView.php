                                    ...
                                    foreach($cactang as $tang){ 
                                        ...
                                        <div style="height:35px">
                                            ...
                                            foreach($tang['room'] as $phong){
                                                ...
                                                echo '
                                                <a class="'.$banner.'"style="margin-right: 5px; padding: 2px; border-radius: 3px;" href="'.WEB_ROOT.'/admin/room/?r_id='.$phong['r_id'].'">'.$phong['nameroom'].'</a>
                                                '; 
                                            }
                                            echo '<a class="phong xam" href="'.WEB_ROOT.'/admin/addRoom/?a_id='.$_GET['a_id'].'&f_id='.$tang['floor']['f_id'].'&isfloor='.$tang['floor']['isfloor'].'">Thêm</a>';
                                            echo '</div>';
                                        }
                                ?>
                            </ul>
