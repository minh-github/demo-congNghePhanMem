                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="<?php echo WEB_ROOT;?>/admin/create/" class="ltn__form-box contact-form-box" enctype="multipart/form-data" method="post" id="registerForm">
                            ...
                            <label for="image" style="margin-bottom: 30px; width: 100%;"><div class="theme-btn-1 btn btn-iamge-color" style="width:100%;" type="submit">AVARTAR</div></label>
                        ...
                        <div class="by-agree text-center">
                            <div class="go-to-btn mt-50">
                                <a href="<?php echo WEB_ROOT;?>/admin/">ALREADY HAVE AN ACCOUNT ?</a>
                            </div>
                        </div>
                    </div>
                </div>
