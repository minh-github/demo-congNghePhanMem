        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12"> 
                    ...
                    ?>                   
                    <form action="<?php echo WEB_ROOT;?>/admin/updateApart/" method="post"  enctype="multipart/form-data" id="formAdd">
                    <input type="text" name="ad_id" hidden value ="<?php echo $_SESSION['ad_id']?>">
                        <input type="text" hidden name="a_id" value="<?php echo $_GET['a_id']; ?>">
                            ...
                            <div class="tab-pane fade active show" id="liton_tab_3_1">
                                <div class="ltn__apartments-tab-content-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="floor" placeholder="Số tầng" value="<?=$floor?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-item input-item-textarea ltn__custom-icon">
                                                <input type="text" name="area" placeholder="Diện tích (vd: 120)" value="<?=$area?>">
                                            </div>
                                        </div>
                                    </div>
                                    <h6>Nội dung</h6>
                                    ...
                                    <div class="row">
                                    <div class="flex">
                                        <select class="province" name="tinh" form="formAdd" value="<?=$province?>">
                                        </select>
                                        <select class="wards" name="huyen" form="formAdd" value="<?=$district?>">
                                        </select>
                                    </div>
                                    </div>
                                    <div class="btn-wrapper text-center--- mt-0">
                                        <button href="" style="margin-top: 50px;" class="btn theme-btn-1 btn-effect-1 text-uppercase">Cập nhật</button>
                                    </div>
                                </div>
                            </div>
                        </div>
