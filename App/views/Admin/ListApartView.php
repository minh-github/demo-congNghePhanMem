                                    ...
                                    <table class="table table-striped table-hover r-0">
                                        ...
                                        <?php
                                            foreach($data['sub_content']['list'] as $key => $value){
                                                ...
                                                $value['active'] == 1 ? $status = 'đã duyệt' : $status = 'chưa duyệt';
                                                $value['active'] == 1 ? $banner = 'badge-success' : $banner = 'badge-warning';
                                                echo'
                                                <tr>
                                                <td class="title">
                                                    <div class="thumb mr-3 mt-1">
                                                        <a href="'.WEB_ROOT.'/admin/apartDetail/?a_id='.$value['a_id'].'"><img src="'.WEB_ROOT.$thumb[0].'" alt=""></a>
                                                    </div>
                                                    <div>
                                                        <div >
                                                ...
                                                <td>
                                                    <a href="'.WEB_ROOT.'/admin/apartDetail/?a_id='.$value['a_id'].'"><span class="r-3 badge badge-success">Xem</span></a>
                                                    <a href="'.WEB_ROOT.'/admin/editApart/?a_id='.$value['a_id'].'"><span class="r-3 badge badge-warning">Sửa</span></a>
                                                    <a href="'.WEB_ROOT.'/admin/deleteApart/?a_id='.$value['a_id'].'"><span class="r-3 badge badge-danger" onclick="return confirm(\'BẠN CÓ CHẮC MUỐN XÓA ?\')">xóa</span></a>
                                                </td>
                                            </tr>
                                                ';
                                            }
