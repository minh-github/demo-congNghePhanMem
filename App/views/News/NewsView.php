                    ...
                    <div class="tab-content bg-white box-shadow-1 ltn__border position-relative pb-10">
                        <div class="tab-pane fade active show" id="ltn__form_tab_1_1">
                            <div class="car-dealer-form-inner">
                                <form action="<?= WEB_ROOT;?>/news/search/" method="post" class="ltn__car-dealer-form-box row">
                                ...
                                <?php
                                    for($i = 1; $i < $lenght+1;$i++){
                                        if (isset($_GET['page'])) {
                                            if($i == $_GET['page']){
                                                echo '
                                                <li class="active"><a href="'.WEB_ROOT.'/News/index/?page='.$i.'">'.$i.'</a></li>
                                            ';
                                            }
                                            else{
                                                echo '
                                                    <li><a href="'.WEB_ROOT.'/News/index/?page='.$i.'">'.$i.'</a></li>
                                                ';
                                            }
                                        }
