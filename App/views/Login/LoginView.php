<?php
    if(isset($_GET['message'])){
        $err = $_GET['message'];
        echo '<div style="text-align: center; color:red;">'.$err.'</div>';
    }
?>

<!-- Mirrored from tunatheme.com/tf/html/quarter-preview/quarter-rtl/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Oct 2022 03:54:32 GMT -->
<body>
    <!--[if lte IE 9]>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="account-login-inner">
                        <form action="<?php echo WEB_ROOT;?>/login/check/" class="ltn__form-box contact-form-box" method="post">
                ...
                <div class="col-lg-6">
                    <div class="account-create text-center pt-50">
                        ...
                        <div class="btn-wrapper">
                            <a href="<?php echo WEB_ROOT;?>/Register/" class="theme-btn-1 btn black-btn">CREATE ACCOUNT</a>
                        </div>
                    </div>
                </div>
            </div>
