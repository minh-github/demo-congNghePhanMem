            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top:80px;">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Chung</h6>
                        <h1 class="section-title">Các Thông Tin Cơ Bản</h1>
                    </div>
                </div>
                <div class="col-lg-4 contact-item">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow box-item">
                        <div class="ltn__contact-address-icon">
                            <img src="<?= WEB_ROOT?>/public/assets/img/icons/10.png" alt="Icon Image">
                        </div>
                        <h3>Địa chỉ Email</h3>
                        <p>minhphamquang028@gmail.com</p>
                    </div>
                </div>
                <div class="col-lg-4 contact-item">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow box-item">
                        <div class="ltn__contact-address-icon">
                            <img src="<?= WEB_ROOT?>/public/assets/img/icons/11.png" alt="Icon Image">
                        </div>
                        <h3>Số điện thoại</h3>
                        <p>0789338359 <br> 0565521047</p>
                    </div>
                </div>
                <div class="col-lg-4 contact-item">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow box-item">
                        <div class="ltn__contact-address-icon">
                            <img src="<?= WEB_ROOT?>/public/assets/img/icons/12.png" alt="Icon Image">
                        </div>
                        <h3>Địa chỉ văn phòng</h3>
                        <p>Đại Học CNTT & TT Thái nguyên <br>
                            Tân Thịnh, TP Thái Nguyên, Thái Nguyên</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ltn__team-area pt-115 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Thành Viên</h6>
                        <h1 class="section-title">Các Thành Viên Trong Đội</h1>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="<?= WEB_ROOT;?>/public/assets/img/team/4.jpg" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="<?= WEB_ROOT;?>/public/assets/img/team/2.jpg" alt="Image">
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        <div class="team-img">
                            <img src="<?= WEB_ROOT;?>/public/assets/img/team/5.jpg" alt="Image">
                        </div>
                        <div class="team-info">
...
<hr>
    <div class="ltn__team-area pt-115 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Vị Trí</h6>
                        <h1 class="section-title">Vị Trí Của Văn Phòng</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="google-map mb-120">
        ...
        <div style="width:100%; display:flex;justify-content:center; height:100%;" class="mapouter"><div class="gmap_canvas" style="width:100%; height:100%;"><iframe style="width:100%; height:100%;" id="gmap_canvas" src="https://maps.google.com/maps?q=%C4%91%E1%BA%A1i%20h%E1%BB%8Dc%20c%C3%B4ng%20ngh%E1%BB%87%20th%C3%B4ng%20tin%20v%C3%A0%20truy%E1%BB%81n%20th%C3%B4ng&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://putlocker-is.org"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:1080px;}</style><a href="https://www.embedgooglemap.net">embed google map on website</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:1080px;}</style></div></div>
                ...
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg position-relative text-center---">
                        <div class="coll-to-info text-color-white">
                            <h1>Bạn Đang Tìm Kiếm Ngôi Nhà Của Mình?</h1>
                            <p>Chúng tôi có thể giúp bạn thực hiện ước mơ về một ngôi nhà mới</p>
                        </div>
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-3 btn-white" href="<?= WEB_ROOT;?>/product/">Bắt Đầu Tìm Kiếm <i class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
            </div>
